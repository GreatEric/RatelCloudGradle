...
function NzMessageContainerComponent_nz_message_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("destroyed", function NzMessageContainerComponent_nz_message_1_Template_nz_message_destroyed_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r809); const ctx_r808 = ɵngcc0.ɵɵnextContext(); return ctx_r808.remove($event.id, $event.userAction); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const instance_r807 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("instance", instance_r807);
} }
...
function NzMessageComponent_ng_container_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("innerHTML", ctx_r815.instance.content, ɵngcc0.ɵɵsanitizeHtml);
} }
let globalCounter = 0;
/**
 * @abstract
