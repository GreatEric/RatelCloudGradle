...
function NzCalendarHeaderComponent_nz_option_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const year_r525 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("nzLabel", year_r525.label)("nzValue", year_r525.value);
} }
function NzCalendarHeaderComponent_nz_select_3_nz_option_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "nz-option", 7);
} if (rf & 2) {
    const month_r527 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("nzLabel", month_r527.label)("nzValue", month_r527.value);
} }
function NzCalendarHeaderComponent_nz_select_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ngModelChange", function NzCalendarHeaderComponent_nz_select_3_Template_nz_select_ngModelChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r529); const ctx_r528 = ɵngcc0.ɵɵnextContext(); return ctx_r528.monthChange.emit($event); });
    ...
    ɵngcc0.ɵɵproperty("nzSize", ctx_r524.size)("nzDropdownMatchSelectWidth", false)("ngModel", ctx_r524.activeMonth);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r524.months);
} }
...
function NzCalendarComponent_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("valueChange", function NzCalendarComponent_ng_template_5_Template_date_table_valueChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r536); const ctx_r535 = ɵngcc0.ɵɵnextContext(); return ctx_r535.onDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r532 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("prefixCls", ctx_r532.prefixCls)("value", ctx_r532.activeDate)("activeDate", ctx_r532.activeDate)("cellRender", ctx_r532.dateCell)("fullCellRender", ctx_r532.dateFullCell);
} }
function NzCalendarComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("valueChange", function NzCalendarComponent_ng_template_7_Template_month_table_valueChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r538); const ctx_r537 = ɵngcc0.ɵɵnextContext(); return ctx_r537.onDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r534 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("prefixCls", ctx_r534.prefixCls)("value", ctx_r534.activeDate)("activeDate", ctx_r534.activeDate)("cellRender", ctx_r534.monthCell)("fullCellRender", ctx_r534.monthFullCell);
} }
...
NzCalendarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzCalendarComponent, selectors: [["nz-calendar"]], contentQueries: function NzCalendarComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        const _r531 = ɵngcc0.ɵɵreference(6);
        const _r533 = ɵngcc0.ɵɵreference(8);
        ...
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngIf", ctx.nzMode === "month")("ngIfThen", _r531)("ngIfElse", _r533);
